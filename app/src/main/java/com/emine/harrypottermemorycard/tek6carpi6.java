...
public class tek6carpi6 extends AppCompatActivity {
    int b;
    ...
    ImageButton resim16, resim17, resim18, resim19;
    ImageButton resim20, resim21, resim22, resim23;
    ImageButton resim24, resim25, resim26, resim27;
    ImageButton resim28, resim29, resim30, resim31;
    ImageButton resim32, resim33, resim34, resim35;
    ...
    int randomSayi9, randomSayi10;
    int randomSayi11, randomSayi12;
    int randomSayi13, randomSayi14;
    int randomSayi15, randomSayi16;
    int randomSayi17, randomSayi18;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tek6carpi6);
        ...
        randomSayi9 = random.nextInt(44);
        randomSayi10 = random.nextInt(44);
        randomSayi11 = random.nextInt(44);
        randomSayi12 = random.nextInt(44);
        randomSayi13 = random.nextInt(44);
        randomSayi14 = random.nextInt(44);
        randomSayi15 = random.nextInt(44);
        randomSayi16 = random.nextInt(44);
        randomSayi17 = random.nextInt(44);
        randomSayi18 = random.nextInt(44);

        init();
        ply= MediaPlayer.create(tek6carpi6.this,R.raw.prologue);
        ply.start();
        init();
        ...
        new CountDownTimer(45000, 1000) {
            ...
            public void onFinish() {
                ply=MediaPlayer.create(tek6carpi6.this,R.raw.basarisiz);
                ply.start();
    ...
    private void TabloOlustur(){
        resim0 = findViewById(R.id.boton00);
        resim1 = findViewById(R.id.boton01);
        resim2 = findViewById(R.id.boton02);
        resim3 = findViewById(R.id.boton03);
        resim4 = findViewById(R.id.boton04);
        resim5 = findViewById(R.id.boton05);
        resim6 = findViewById(R.id.boton06);
        resim7 = findViewById(R.id.boton07);
        resim8 = findViewById(R.id.boton08);
        resim9 = findViewById(R.id.boton09);
        resim10 = findViewById(R.id.boton10);
        resim11 = findViewById(R.id.boton11);
        resim12 = findViewById(R.id.boton12);
        resim13 = findViewById(R.id.boton13);
        resim14 = findViewById(R.id.boton14);
        resim15 = findViewById(R.id.boton15);
        resim16 = findViewById(R.id.boton16);
        resim17 = findViewById(R.id.boton17);
        resim18 = findViewById(R.id.boton18);
        resim19 = findViewById(R.id.boton19);
        resim20 = findViewById(R.id.boton20);
        resim21 = findViewById(R.id.boton21);
        resim22 = findViewById(R.id.boton22);
        resim23 = findViewById(R.id.boton23);
        resim24 = findViewById(R.id.boton24);
        resim25 = findViewById(R.id.boton25);
        resim26 = findViewById(R.id.boton26);
        resim27 = findViewById(R.id.boton27);
        resim28 = findViewById(R.id.boton28);
        resim29 = findViewById(R.id.boton29);
        resim30 = findViewById(R.id.boton30);
        resim31 = findViewById(R.id.boton31);
        resim32 = findViewById(R.id.boton32);
        resim33 = findViewById(R.id.boton33);
        resim34 = findViewById(R.id.boton34);
        resim35 = findViewById(R.id.boton35);
    ...
    private void OyunKontrol(int i, final ImageButton gelenResim){
        if(birinci == null){
            ...
            play=MediaPlayer.create(tek6carpi6.this,R.raw.happy);
            play.start();
            ...
            if(birinciSayi == ikinciSayi){
                ...
                bloke = false;
                dogruCevap++;
                play=MediaPlayer.create(tek6carpi6.this,R.raw.alkis);
                play.start();
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        play= MediaPlayer.create(tek6carpi6.this,R.raw.basarisiz);
                        play.start();
                        bloke = false;
                        birinci = null;
                        puanyazdir2();
        ...
        FirebaseFirestore.getInstance().collection("kartinBilgileri").addSnapshotListener((queryDocumentSnapshots, e) -> {
            ...
            if(sonuc>0) {
               // long l=(millisUntilFinished/1000)*sonuc;
                skorboard.setText("Puan: " + sonuc*25);
            }
    ...
    private void puanyazdir2() {
        ...
        FirebaseFirestore.getInstance().collection("kartinBilgileri").addSnapshotListener((queryDocumentSnapshots, e) -> {
            ...
            skorboard.setText("Puan: " +sonuc1*16 );
